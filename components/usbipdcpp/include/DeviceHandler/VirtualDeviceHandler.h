...
namespace usbipdcpp
{
    ...
    public:
        explicit VirtualDeviceHandler(UsbDevice &handle_device, StringPool &string_pool,
                                      const Version &usb_version = {2, 0, 0}) : DeviceHandlerBase(handle_device), string_pool(string_pool), usb_version(usb_version)
        {
    ...
    protected:
        ...
        void change_string_configuration(const std::wstring &new_str)
        {
            ...
            ESP_LOGE("usbipdcpp_VirtualDeviceHandler", "string_configuration_value无效");
        ...
        void change_string_manufacturer(const std::wstring &new_str)
        {
            ...
            ESP_LOGE("usbipdcpp_VirtualDeviceHandler", "string_manufacturer_value无效");
            throw std::system_error(std::make_error_code(std::errc::invalid_argument));
        }
        ...
        void change_string_product(const std::wstring &new_str)
        {
            ...
            ESP_LOGE("usbipdcpp_VirtualDeviceHandler", "string_product_value无效");
            throw std::system_error(std::make_error_code(std::errc::invalid_argument));
        }
        ...
        void change_string_serial(const std::wstring &new_str)
        {
            ...
            ESP_LOGE("usbipdcpp_VirtualDeviceHandler", "string_serial_value无效");
            throw std::system_error(std::make_error_code(std::errc::invalid_argument));
        }
