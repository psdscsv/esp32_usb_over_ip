...
namespace usbipdcpp
{
    ...
    {
    public:
        explicit AbstDeviceHandler(UsbDevice &handle_device) : handle_device(handle_device)
        {
        }
    ...
    protected:
        ...
        virtual void handle_isochronous_transfer(
            ...
            const std::vector<UsbIpIsoPacketDescriptor> &iso_packet_descriptors, std::error_code &ec) = 0;
